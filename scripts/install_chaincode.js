...
var chaincode_id = 'blockcertsx';									//set desired chaincode id to identify this chaincode
...
fcw.enrollWithAdminCert(cp.makeEnrollmentOptionsUsingCert(), function (enrollErr, enrollResp) {
	if (enrollErr != null) {
		...
		var opts = {
			...
			path_2_chaincode: 'blockcertsx',				//path to chaincode from <marbles root>/chaincode/src/
